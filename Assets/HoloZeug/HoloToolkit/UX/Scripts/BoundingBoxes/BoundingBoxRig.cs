...
namespace HoloToolkit.Unity.UX
{
    ...
    public class BoundingBoxRig : MonoBehaviour
    {
        ...
        private Vector3 rotateHandleSize = new Vector3(0f, 0f, 0f);
            ...
            set
            {
                if (destroying == false)
                {
                    ...
                    if (cornerHandles != null)// && rotateHandles != null)
                    {
                        ...
                        {
                            if (handle != null) //daniel
                            {
                                handle.SetActive(false); //daniel: was "value"
                            }
        ...
        public List<Vector3> GetBounds() //daniel: changed private to public
        {
